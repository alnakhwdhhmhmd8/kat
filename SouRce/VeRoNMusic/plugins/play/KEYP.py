...
async def ihppd(client: Client, message: Message):
    ...
    await client.send_voice(message.chat.id,url,caption="🥀✨ ¦ تـم اختيـار الاغـنـية لك من جـاك" ,parse_mode=enums.ParseMode.HTML)
...
async def ihssd(client: Client, message: Message):
    ...
    await client.send_photo(message.chat.id,url,caption="🥀✨ ¦ تـم اختيـار صوره لك من جـاك",parse_mode=enums.ParseMode.HTML)
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def ihqwd(client: Client, message: Message):
    ...
    await client.send_animation(message.chat.id,url,caption="🥀✨ ¦ تـم اختيـار ملصق لك من جـاك",parse_mode=enums.ParseMode.HTML)
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def ihjnd(client: Client, message: Message):
    ...
    await client.send_photo(message.chat.id,url,caption="🥀✨ ¦ تـم اختيـار اقتباس لك من جـاك",parse_mode=enums.ParseMode.HTML)
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def ihybd(client: Client, message: Message):
    ...
    await client.send_photo(message.chat.id,url,caption="🥀✨ ¦ تـم اختيـار هيدرات لك من جـاك",parse_mode=enums.ParseMode.HTML)
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def ihdh(client: Client, message: Message):
    ...
    await client.send_voice(message.chat.id,url,caption="🥀✨ ¦ تـم اختيـار ايـه قرآنيه لك من جـاك",parse_mode=enums.ParseMode.HTML)
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def ithd(client: Client, message: Message):
    ...
    await client.send_voice(message.chat.id,url,caption="🥹♥ ¦ تـم اختيـار الشيخ نقشبندي لك من جـاك",parse_mode=enums.ParseMode.HTML)
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def ihud(client: Client, message: Message):
    ...
    await client.send_photo(message.chat.id,url,caption="╭⦿ᚐ<b>⭓ᴍᴜˢɪᴄ♪✘⸢ᴊᴀᴋ♪\n╰⦿ᚐ @xvwwvl",parse_mode=enums.ParseMode.HTML)
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def ihgd(client: Client, message: Message):
    ...
    await client.send_audio(message.chat.id,url,caption="🥀✨ ¦ تـم اختيـار استوري لك من جـاك",parse_mode=enums.ParseMode.HTML)
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def ihd(client: Client, message: Message):
    rl = random.randint(1,50)
    url = f"https://t.me/yoipopl/{rl}"
    await client.send_audio(message.chat.id,url,caption="╭⦿ᚐ<b>⭓ᴍᴜˢɪᴄ♪✘⸢ᴊᴀᴋ♪\n╰⦿ᚐ @xvwwvl",parse_mode=enums.ParseMode.HTML)
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def ihd(client: Client, message: Message):
    rl = random.randint(1,90)
    url = f"https://t.me/opuml/{rl}"
    await client.send_voice(message.chat.id,url,caption="╭⦿ᚐ<b>⭓ᴍᴜˢɪᴄ♪✘⸢ᴊᴀᴋ♪\n╰⦿ᚐ @xvwwvl",parse_mode=enums.ParseMode.HTML)
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def ihd(client: Client, message: Message):
    rl = random.randint(2,90)
    url = f"https://t.me/GifWaTaN/{rl}"
    await client.send_animation(message.chat.id,url,caption="╭⦿ᚐ<b>⭓ᴍᴜˢɪᴄ♪✘⸢ᴊᴀᴋ♪\n╰⦿ᚐ @xvwwvl",parse_mode=enums.ParseMode.HTML)
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
