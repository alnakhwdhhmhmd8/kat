...
VERONBOTS_CHANNEL = getenv("VERONBOTS_CHANNEL", "https://t.me/xvwwvl")

QURAN_CHANNELL = getenv("VERONBOTS_CHANNEL", "https://t.me/xvwwvl") 
...
START_video_URL = getenv(
    "START_video_URL", "https://t.me/s2wwv/26"
)
